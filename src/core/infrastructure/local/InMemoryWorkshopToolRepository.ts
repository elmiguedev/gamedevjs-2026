...
const TOOLS = [
  ...
  new WorkshopTool('robot-recolector', 'Collector Bot', 'Automatically collects 1 scrap every second.', 600, 150, 3, 28, 30, { type: 'passiveScrap', amount: 1, intervalSeconds: 1 }),
