...
const TOOLS = [
  ...
  new WorkshopTool('robot-recolector', 'Collector Bot', 'Automatically collects 10 scrap every 2s.', 600, 150, 3, 28, 30, { type: 'passiveScrap', amount: 10, intervalSeconds: 2 }),
