...
const TOOLS = [
  ...
  new WorkshopTool('iman-poderoso', 'Power Magnet', 'Reduces collection cooldown to 1s.', 220, 50, 2, 18, 20, { type: 'collectCooldown', seconds: 1 }),
  new WorkshopTool('robot-recolector', 'Collector Bot', 'Automatically collects 1 scrap every 3s.', 450, 150, 3, 28, 30, { type: 'passiveScrap', amount: 1, intervalSeconds: 3 }),
