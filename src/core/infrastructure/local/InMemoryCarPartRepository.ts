...
const PARTS = [
  ...
  new CarPart('chasis-prisma', 'chasis', 'Prism Chassis', { resistance: 16 }, 420, 240, 3, 30, 32, 'Own Nexus Chassis and prestige 1'),
  ...
  new CarPart('rueda-umbra', 'rueda', 'Umbra Wheels', { direction: 6, resistance: 7 }, 260, 150, 3, 30, 24, 'Prestige 1'),
  ...
  new CarPart('direccion-oracle', 'direccion', 'Oracle Steering', { direction: 7, acceleration: 2 }, 620, 300, 3, 30, 24, 'Workshop level 3 or blueprint'),
  ...
  new CarPart('motor-flux', 'motor', 'Flux Engine', { acceleration: 8, speed: 8 }, 1450, 620, 3, 30, 30, 'Prestige 2'),
  new CarPart('motor-ionico', 'motor', 'Ionic Engine', { acceleration: 6, speed: 6 }, 1100, 480, 3, 30, 28, 'Energy/special blueprint'),
